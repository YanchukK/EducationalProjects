    ...
    class Program
    {
        static void Main(string[] args)
        {
            var data = new List<object>() {
                        ...
                        new Book() { Author = "Stephen King", Name="Finders Keepers 300 p", Pages = 300},
                        "Leonardo DiCaprio"
                    };
            ...
            //var dictionary = data.OfType<Film>();


            //var result = from d in dictionary
            //             where d.Actors.Contains()
